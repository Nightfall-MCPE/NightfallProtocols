...
class CustomStandardEntityEventBroadcaster implements EntityEventBroadcaster{
	...
	public function syncActorData(array $recipients, Entity $entity, array $properties) : void{
		//HACK! as of 1.18.10, the client responds differently to the same data ordered in different orders - for
	...
	public function onEntityEffectAdded(array $recipients, Living $entity, EffectInstance $effect, bool $replacesOldEffect) : void{
		//we may need yet another effect <=> ID map in the future depending on protocol changes
	...
	public function onMobMainHandItemChange(array $recipients, Human $mob) : void{
		//we could send zero for slot here because remote players don't need to know which slot was selected
