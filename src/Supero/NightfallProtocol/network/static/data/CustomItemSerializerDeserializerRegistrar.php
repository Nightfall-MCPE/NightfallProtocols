...
final class CustomItemSerializerDeserializerRegistrar{

	//SOMEHOW FIND A WAY TO BYPASS THIS SHIT?

	public function __construct(
		private ?ItemDeserializer $deserializer,
		private ?CustomItemSerializer $serializer
	){
	 ...
	 * try and make this less ugly; for the most part the logic is symmetrical, it's just difficult to write it
	 * in a unified manner.
	 */
