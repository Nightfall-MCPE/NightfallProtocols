...
class InGamePacketHandler extends PacketHandler{
	...
	public function handlePlayerAuthInput(PlayerAuthInputPacket $packet) : bool{
		...
		if($itemStackRequest !== null){
			...
			$this->session->sendDataPacket(ItemStackResponsePacket::createPacket([$result]));
		}
	...
	private function handleSingleItemStackRequest(CustomItemStackRequest $request) : ItemStackResponse{
	...
	public function handleItemStackRequest(ItemStackRequestPacket $packet) : bool{
		...
		$this->session->sendDataPacket(ItemStackResponsePacket::createPacket($responses));
