...
final class CustomAbilitiesLayer{
	...
	public static function decode(PacketSerializer $in) : self{
		...
		$verticalFlySpeed = $in->getProtocol() >= CustomProtocolInfo::PROTOCOL_1_21_60 ? $in->getLFloat() : 0.0;
		...
		if($in->getProtocol() >= CustomProtocolInfo::PROTOCOL_1_21_60 && ($setAbilities & (1 << self::ABILITY_VERTICAL_FLY_SPEED)) === 0){
	...
	public function encode(PacketSerializer $out) : void{
		...
		if($out->getProtocol() >= CustomProtocolInfo::PROTOCOL_1_21_60 && $this->verticalFlySpeed !== null){
