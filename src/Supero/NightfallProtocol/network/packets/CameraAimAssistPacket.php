...
class CameraAimAssistPacket extends PM_Packet {
	...
	public static function createPacket(string $presetId, Vector2 $viewAngle, float $distance, CameraAimAssistTargetMode $targetMode, CameraAimAssistActionType $actionType) : self{
		$result = new self();
